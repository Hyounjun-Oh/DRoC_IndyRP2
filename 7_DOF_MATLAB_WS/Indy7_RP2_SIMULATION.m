...
% Desired Pose
desired_pose_1 = [-400 400 500 0 0 0];

desired_pose_array = [500 500 500 0 0 0;
                      500 -500 0 0 0 0;
                      -500 500 500 0 0 0
                      0 0 1325 0 0 0];
% Current Pose
...
b = [initial_pose(1:3,8)', 0, 0, 0;vi;ai;desired_pose_array(1,:);vf;af];
a = M\b;
c = ones(size(t));
    ...
    if iter ~= given_pose
        ...
        if iter == 1
            ...
            M = [1 ti ti^2 ti^3 ti^4 ti^5;
                 ...
                 0 1 2*tf 3*(tf^2) 4*(tf^3) 5*(tf^4);
                 0 0 2 6*tf 12*(tf^2) 20*(tf^3)];
            b = [initial_pose(1:3,8)', 0, 0, 0;vi;ai;desired_pose_array(iter,:);vf;af];
            a = M\b;
            c = ones(size(t));
